...
<html lang="en">
  <head>
    ...
    ?>  
        ...
        <link rel="stylesheet" href="css/Desktop/inquiry.css">
    <?php
        }
        else if($theme == "dark"){
    ?>
        <link rel="stylesheet" href="css/Desktop/globalDark.css">
        <link rel="stylesheet" href="css/Desktop/inquiryDark.css">
    <?php   
        }
        else if($theme == "light"){
    ?>
        <link rel="stylesheet" href="css/Desktop/globalLight.css">
        <link rel="stylesheet" href="css/Desktop/inquiryLight.css">
    <?php     
        }
        else{
    ?>
    ...
    ?>
     ...
     <link rel="stylesheet" href="css/Mobile/inquiry.css">
    ...
    <div id="up">
        <div id="header" class="navbar_header">
            ...
            <div class="two">
                    ...
                    <a href="inquiry.php"  style="color:#929292;" class="navbar_a navbar_a_active">Inquiry</a>
        ...
        <p id="inquiry_text">Send us a message</p>
       
        <div id="top_three">
            <div class="box">
                <img src="images/inq_box1.png">
                <?php echo $row_g['g_Contact']; ?>
                <span style="visibility:hidden;">.</span>
            </div>
            <div class="box">
                <img src="images/inq_box3.png">
                <span style="width:60%; text-align:center;"><?php echo $row_g['g_Location']; ?></span>
            </div>
            <div class="box">
                <img src="images/inq_box2.png">
                <?php echo $row_g['g_Email']; ?>
                <span style="visibility:hidden;">.</span>
            </div>
        </div>
        ...
        <div id="content">
            <div id="rl_cont">
                ...
                <div id="left"> 
                    <div id="inp">
                        ...
                        <div id="input_container">
                            ...
                            <input type="text" class="input_one" placeholder="First Name" id="fname" name="fname">
                        </div>   
                    </div>       
                    ...
                    <div id="inp">
                        ...
                        <div id="input_container">
                            <div id="img"><img src="images/icons/dashboard/name_step.png"></div>
                            <input type="text" class="input_one" placeholder="Last Name" id="lname" name="lname">
                        </div>    
                    </div>  
                    ...
                    <div id="inp">
                        ...
                        <div id="input_container">
                            ...
                            <input type="text" class="input_one" placeholder="What's your email?" id="email" name="email" style="text-transform:none;">
                        </div>   
                    </div>   
                </div>
                ...
                <div id="right"> 
                        <label>Message</label>
                        <textarea id="question" class="input_two" placeholder="Your questions?" name="question"></textarea>       
                </div>
                </div>

                <div id="for_button">
                    <p id="validation_inquiry">.</p>
...
<div class="for_mobile"><!--For Mobile div-->
    ...
    <div id="up">
        ...
        <div id="content_mobile">
            <p id="inquiry_text">Inquiry</p>

            <center><img src="images/inquiry_img.png"></center>
            <form action="javascript:void(0)" method="post" id="ajax-form-mobile">
                <input type="text" class="input_one" placeholder="First Name" style="margin-top:4%;" id="fnameM" name="fname">
                <input type="text" class="input_one" placeholder="Last Name" id="lnameM" name="lname">
                <input type="text" class="input_one" placeholder="What's your email?" id="emailM" name="email">
                <textarea id="questionM" class="input_two" placeholder="Your questions?" name="question"></textarea>
                <div><p id="validation_inquiryM">.</p></div>
                <button type="submit">SEND MESSAGE</button>
            </form>
        </div><!--End of content div-->
    ...
    <div id="bot">
       ...
       <p class="f3_subtext">© 2021 Robles Maternity Clinic. All rights reserved</p>
    ...
    <div id="hamburger_container">
        <div id="hamburger">
            ...
            <div id="inquiry_burger" class="burger" style="background:#78CCF2;">Inquiry</div>
...
<div id="sweetalert_container_Mobile">
    <div id="succes_alert_Mobile">
        ...
        <p class="message_alert">Expect a feedback from us later,</p>
        <p class="message_alert">Kindly check your email in a few hours.</p>
        <button id="close_alert_Mobile">OK</button>
        </div>
    </div>
</div>  
...
<!-- Ajax for making inquiry -->
<script src="ajax/inquiry.js"></script>
<script src="ajax/inquiryMobile.js"></script>


<script>
document.querySelector(".aboutpageLink").onclick = function() {
    window.open("about.php", '_blank');
};

document.querySelector(".servicespageLink").onclick = function() {
    window.open("services.php", '_blank');
};

document.querySelector(".inquirypageLink").onclick = function() {
    window.open("inquiry.php", '_blank');
};
</script>
