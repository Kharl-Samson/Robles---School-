$(document).ready(function($){
    ...
    // on submit...
    $('#ajax-form_admin_editprofile').submit(function(e){
    e.preventDefault();
...
$.ajax({
    type:"POST",
    url: 'z-Ajax-AdminEditProfile.php',
    ...
    success: function(response){
        if($.trim(response) == "success"){
            ...
            $('.message_alert').text("Sorry, username already exists. Try another username!")
            ...
            $('#gif_alert').attr('src','images/gif/error_validation.gif');
            $('.header_text_validation_appointment').text("Error!")
            $('.message_alert').text("Sorry, email already exists. Try another email!")
