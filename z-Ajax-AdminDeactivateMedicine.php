...
session_start();
    ...
    date_default_timezone_set('Asia/Manila');
      ...
      $id = mysqli_real_escape_string($conn, $_POST['key_medDeact']);
      $name_key= mysqli_real_escape_string($conn, $_POST['key_medDeactName']); 
            ...
            while($z<count($arraySubname)){
                if($arrayEditDelete[$z] == $id){
                    ...
                    $convertedStatus = implode(",",$arrayStatus);    
                        ...
                        $descriptionAudit = $key_nameAudit." deactivated a medicine with the name ".$arraySubname[$z].".";
