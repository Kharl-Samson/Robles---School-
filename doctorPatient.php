                ...
                <div id="table_patient_div">
                    ...
                    <div id="table_patient_container">
                        ...
                        while($row = mysqli_fetch_array($search_patient)): 
                            echo "<tr>";   
                        ?>      
                                    <td class="td_block1<?php echo $sr; ?>" id="td_id"><?php echo $row['id']; ?></td>    
                                    ...
                                    <td class="hover_table_pending" style="padding-left:10%;"> 
                                            <button id="view_btn" title="View" onclick="viewPatient_doctorAcc('<?php echo $row['id']; ?>')"><img src='images/icons/dashboard/view_icon.png' /></button>
                                            <button id="report_btn" title="Make Report" style="background-color:#5FB1F2;"  onclick="makeReport_doctorAcc('<?php echo $row['id']; ?>')"><img src='images/icons/dashboard/report.png' /></button>
                                    </td>      
                        <?php
                            echo "</tr>";
