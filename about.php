...
<html lang="en">
  <head>
    ...
    ?>
        ...
        <link rel="stylesheet" href="css/Desktop/aboutDark.css">
    <?php   
        }
        else if($theme == "light"){
    ?>
        <link rel="stylesheet" href="css/Desktop/globalLight.css">
        <link rel="stylesheet" href="css/Desktop/aboutLight.css">
    <?php     
        }
        else{
    ?>
...
<div class="for_desktop"><!--For Descktop div-->
    ...
    <div id="up">
        <div id="header" class="navbar_header">
            ...
            <div class="two">
                    ...
                    <a href="about.php" style="color:#929292;" class="navbar_a navbar_a_active">About Us</a>  
            </div>
    ...
    <div id="for_bottom_header_about">
            <div id="robles_about_box" data-aos="zoom-in-up">
                    ...
                    <div id="mid">                                
                        <p class="ourHistory_subtext"><?php echo $row_g['a_about']; ?></p>
    ...
    <div id="content2_about">
        ...
        <div id="getIntouch">
            ...
            <div id="right" data-aos="fade-up" data-aos-duration="500">
                <div style="width: 100%; height: 100%; border-radius:10px;"><iframe style="border-radius:10px;" width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="<?php echo $row_g['googlemap']; ?>"><a href="https://www.gps.ie/sport-gps/">bike gps</a></iframe></div>
            </div>
...
<div class="for_mobile"><!--For Mobile div-->
    ...
    <div id="up">
        ...
        <div id="content">
            ...
            <center><img src="images/about_img.png" id="about_img_mobile"></center>
    ...
    <div id="content3">
      <p id="compName"><?php echo $rowNameFirst; ?></p>
      <p id="compName"><?php echo $rowSecondName; ?></p>
      <p><?php echo $row_g['a_about']; ?></p>
      <p>Our Clinic Provides:</p>
      <div>Care</div>
      <div style="background-color:#00c8fb;">happiness</div>
      <div style="background-color:#00c8fb;">quality</div>
      <div>respect</div>
    </div><!--End of content3-->

    <center>
    <img src="upload_img_generic/<?php echo $row_g['a_layoutimg']; ?>" class="about_robles_img">
    </center>


    <div id="getIntouch">
                <div id="line"></div>
                <P id="b">We take these values to heart</P>
    ...
    <div id="content4">
           <p class="location_text">Get in touch</p>
           
           <div style="width: 80%; height: 25vh; border-radius:10px; margin:7% auto;"><iframe style="border-radius:10px;" width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="<?php echo $row_g['googlemap']; ?>"><a href="https://www.gps.ie/sport-gps/">bike gps</a></iframe></div>
    ...
    <div id="hamburger_container">
        <div id="hamburger">
            ...
            <div id="about_burger" class="burger"  style="background:#78CCF2;">About Us</div>
