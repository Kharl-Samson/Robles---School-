                    ...
                    <div id="edit_content1" class="edit_basic_info">
                        ...
                        <div class="for_inp"><!-- Address-->
                            <div id="inp_cont">
                                    ...
                                    <select id="region"  onchange="test()" style="margin-top:-6.5vh; opacity:0%;" onclick="regiondropdown()"></select>
                           ...
                           <div id="inp_cont">
                                    ...
                                    <select id="province"> <option value="" disabled selected hidden><?php echo $row['prov']?></option></select>    
                                    <input type="hidden" value="<?php echo $row['prov']; ?>" name="prov" id="prov" onkeyup="removeborder_adminEditProfile('prov')">    
                            </div> 
                            <div id="inp_cont">
                                    <label>Municipality : <span style="color:red; font-size:2.5vh;">*</span></label>   
                                    <select id="city" ><option value="" disabled selected hidden><?php echo $row['mun']?></option></select>     
                                    <input type="hidden" value="<?php echo $row['mun']; ?>" name="mun" id="mun" onkeyup="removeborder_adminEditProfile('mun')">  
                            </div> 
                        </div>
                        ...
                        <div class="for_inp"><!-- Address-->
                            <div id="inp_cont">
                                    ...
                                    <select id="barangay" ><option value="" disabled selected hidden><?php echo $row['bar']?></option></select>
