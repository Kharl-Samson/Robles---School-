...
$EmailUsername = mysqli_real_escape_string($conn, $_POST['recovery_email']);
  ...
  $s_email = "SELECT * FROM `patientinfo_db` WHERE email='$EmailUsername' or username='$EmailUsername'";
  $result_email = mysqli_query($conn, $s_email);
  $num_email = mysqli_num_rows($result_email); 


  $sqlGet = "SELECT * FROM `patientinfo_db` WHERE email='$EmailUsername' or username='$EmailUsername'";
...
<a style="text-decoration:none;" href="https://www.roblesmaternityclinic.site/patientRecoverpass.php?key='.$tosendEmail.'">
