...
<html lang="en">
  <head>
     ...
     <link rel="stylesheet" href="css/Desktop/Admin-adminViewPatient.css">
...
<div id="notification_content">
    ...
    <div id="right" class="right_content_dashboard for_reload_right_table">
            ...
            <div id="dashboard_content">
                ...
                <div id="info_profile"> 
                    <img src="<?php echo $row1['profile'];?>"  onerror="this.src='upload_img/account.png'">
                    <div id="right">
                ...
                <div id="addpatient_div" class="viewPatientContainer">
                   ...
                   <div class="col">
                       <div id="left">
                           ...
                           <p class="content"><?php echo $row1['fname']?></p>
                       </div>
                       <div id="right">
                           <div id="one">
                   ...
                   <div class="col">
                       ...
                       <div id="right">
                            <p class="label">Age</p>
                            <p class="content"><?php echo $row1['age']?> yr/s old</p>
                       </div>
                   </div>
                   ...
                   <div class="col">
                       <div id="left">
                           ...
                           <p class="content"><?php echo $row1['lname']?></p>
                       </div>
                       <div id="right">
                   ...
                   <div class="col">
                       <div id="left">
                           ...
                           <p class="content"><?php echo $row1['barangay']?></p>
                       </div>
                       <div id="right">
                   ...
                   <div class="col">
                       <div id="left">
                           ...
                           <p class="content"><?php echo $row1['municipality']?></p>
                       </div>
                       <div id="right">
                   ...
                   <div class="col">
                       <div id="left">
                           ...
                           <p class="content"><?php echo $row1['province']?></p>
                       </div>
                       <div id="right">
...
<?php
        ...
        <!--------------------------------------------------------------------->
                    ...
                    <div style="width:95%; display:flex; justify-content: flex-end; padding-right:5%;">
                        <Button onclick="goBackViewPatient()">Back</Button>
                    </div>
                </div>
