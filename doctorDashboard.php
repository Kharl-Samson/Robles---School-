...
<html lang="en">
  <head>
     ...
     <link rel="stylesheet" href="css/Desktop/Doctor-dashboardDoctor.css">
...
<div id="notification_content">
    ...
    <div id="right" class="right_content_dashboard">
            ...
            <div id="dashboard_content">
                    <div id="left">
                        <div id="layer1">
                            <div id="left1"><img src="images/icons/dashboard/doctor_dash.png" alt=""></div>
                            <div id="center1">
                                    <p id="welcome">Welcome</p>
                                    <p id="name">Dra. <?php echo $row['fname']." ".$row['lname'] ; ?></p>
                                    <p id="niceday">Have a nice day at work</p>
                            </div>
                            <div id="right1">
                                <img src="images/icons/dashboard/doctor_dasgbg.png" alt="">
                            </div>
                        </div>
                        <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div id="patient">
                                                ...
                                                <div title="View Patient" onclick="viewPatient_doctorAcc('<?php echo $row['patient_id']; ?>')" id="view_recent"><img src="images/icons/dashboard/view_blue.png">&nbsp;View</div>
                                            </div>
                                        </td>  
                                        <?php
                                                }
