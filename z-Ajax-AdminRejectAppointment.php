...
$date = mysqli_real_escape_string($conn, $_POST['date_inp']);
$time = mysqli_real_escape_string($conn, $_POST['time_inp']);
$email1 = mysqli_real_escape_string($conn, $_POST['email_inp']);
$name = mysqli_real_escape_string($conn, $_POST['name_inp']);
$reason = trim($_POST['reasons_reject']);

$key = mysqli_real_escape_string($conn, $_POST['id_inp']);
...
$descriptionAudit = $key_nameAudit." rejected an appointment.";
...
<b style=" font-size:2.3vh;">To Mrs/Ms. '.$name .',</b> <br><br><br>

<span style="font-size:2vh; ">'.$reason.'</span> <br><br><br>
...
<center>
<p style="font-size:2vh;margin:0%;color:white;">&copy; Robles Maternity Clinic  2021. All rights reserved</p>
</center>
</div>';
